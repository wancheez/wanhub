...
_TRANSLATE_SYSTEM = (
    ...
    "оставляй как есть.\n"
    "3. Все четыре варианта a должны остаться РАЗНЫМИ строками. Если "
    ...
    "4. Порядок вариантов в a НЕ менять."
)
...
# Module-level Session Token. Один на процесс — для нагрузки бота этого хватает,
# у opentdb нет per-chat токенов, а заводить персистентное хранилище ради
# теоретической изоляции чатов — оверкилл.
