...
HELP_TEXT = (
    ...
    "/riddles — загадки от LLM (отвечай <b>реплаем</b> на сообщение)\n"
    "/geo — Geo Guesser: угадай страну по уличному фото (пиши страны в чат, "
    "бот подскажет теплее/холоднее)\n"
    "Можно и текстом: <i>Чат, запусти квиз</i> · <i>Чат, поиграем в флаги</i> · "
    "<i>Чат, столицы на 10</i> · <i>Чат, запусти загадки</i>\n\n"
    "Команды:\n"
