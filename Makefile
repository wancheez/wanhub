...
help:
	...
	@echo "  backup             - снапшот баз + картинки как есть, залить на WebDAV прямо сейчас"
	@echo "  backup-dry         - снапшот + архив локально, без заливки (DRY_RUN)"
	@echo "  backup-restore     - скачать последний бекап баз + недостающие картинки и разложить"
